...
extension Defaults.Keys {
    ...
    static let windowSnapping = Key<Bool>("windowSnapping", default: true, iCloud: true)
    ...
    static let moveCursorWithWindow = Key<Bool>("moveCursorWithWindow", default: true, iCloud: true)
